//https://codeforces.com/group/PVbQ8eK2T4/contest/377095/submission/155155793
...
int countState(State &state) {//heuristic + steps made
    ...
    return 10*(manhattan + linearConflict) + state.actions.length();//it is not important to have precise heuristic
}
